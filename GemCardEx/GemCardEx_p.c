...
typedef struct _GemCardEx_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } GemCardEx_MIDL_TYPE_FORMAT_STRING;

typedef struct _GemCardEx_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } GemCardEx_MIDL_PROC_FORMAT_STRING;

typedef struct _GemCardEx_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } GemCardEx_MIDL_EXPR_FORMAT_STRING;
...
extern const GemCardEx_MIDL_TYPE_FORMAT_STRING GemCardEx__MIDL_TypeFormatString;
extern const GemCardEx_MIDL_PROC_FORMAT_STRING GemCardEx__MIDL_ProcFormatString;
extern const GemCardEx_MIDL_EXPR_FORMAT_STRING GemCardEx__MIDL_ExprFormatString;


extern const MIDL_STUB_DESC Object_StubDesc;


extern const MIDL_SERVER_INFO ISCardDatabaseEx_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO ISCardDatabaseEx_ProxyInfo;
...
static const GemCardEx_MIDL_PROC_FORMAT_STRING GemCardEx__MIDL_ProcFormatString =
    {
        0,
        {
...
static const GemCardEx_MIDL_TYPE_FORMAT_STRING GemCardEx__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
/* Object interface: ISCardDatabaseEx, ver. 0.0,
   GUID={0xFF1B206D,0xD909,0x4B7D,{0xB8,0x2F,0xD7,0xD6,0x54,0x98,0x15,0xE3}} */

#pragma code_seg(".orpc")
static const unsigned short ISCardDatabaseEx_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO ISCardDatabaseEx_ProxyInfo =
    {
    &Object_StubDesc,
    GemCardEx__MIDL_ProcFormatString.Format,
    &ISCardDatabaseEx_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO ISCardDatabaseEx_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    GemCardEx__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(8) _ISCardDatabaseExProxyVtbl = 
{
    &ISCardDatabaseEx_ProxyInfo,
    &IID_ISCardDatabaseEx,
    ...
    (void *) (INT_PTR) -1 /* ISCardDatabaseEx::ListReaders */
};


static const PRPC_STUB_FUNCTION ISCardDatabaseEx_table[] =
{
...
CInterfaceStubVtbl _ISCardDatabaseExStubVtbl =
{
    &IID_ISCardDatabaseEx,
    &ISCardDatabaseEx_ServerInfo,
    8,
    &ISCardDatabaseEx_table[-3],
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    GemCardEx__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _GemCardEx_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_ISCardDatabaseExProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _GemCardEx_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_ISCardDatabaseExStubVtbl,
    0
};

PCInterfaceName const _GemCardEx_InterfaceNamesList[] = 
{
    "ISCardDatabaseEx",
    0
};

const IID *  const _GemCardEx_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _GemCardEx_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _GemCardEx, pIID, n)

int __stdcall _GemCardEx_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_GemCardEx_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo GemCardEx_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _GemCardEx_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _GemCardEx_StubVtblList,
    (const PCInterfaceName * ) & _GemCardEx_InterfaceNamesList,
    (const IID ** ) & _GemCardEx_BaseIIDList,
    & _GemCardEx_IID_Lookup, 
    1,
    2,
